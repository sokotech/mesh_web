   ...
   $("#btn_contact").click(function()
   {
   	$(".contact_result").hide();
		...
		{		
   		...
   		//<input type="text" name="b_357ca9f48e009ad4a37ae7317_eb109a5aea" tabindex="-1" value=""></div>
   		//<input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
			$.ajaxSetup({
    				crossDomain: true,
			});			
			var params={"FNAME":name, "EMAIL":email,"LNAME":"", 
							"LANGUAGE": lng};		
			$.post("https://tech.us17.list-manage.com/subscribe/post?u=357ca9f48e009ad4a37ae7317&amp;id=eb109a5aea",
					params)
			   .done(function(data)
			   {
			   	alert(data);
